          ...
          >
            <div className="flex justify-between items-center mb-4 pb-2 border-b border-outline-variant/50">
              <h3 className="font-sans font-bold text-lg text-primary flex items-center gap-2">
                <HelpCircle className="w-5 h-5" /> HQ Alpha Support Center
              </h3>
              <button
                onClick={onClose}
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <div className="bg-surface-container-low p-4 rounded-lg border border-outline-variant/40 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-mono text-on-surface-variant">
                  <div>Grid ID: <span className="text-on-surface">AETHER-HQ-ALPHA-2026</span></div>
                  <div>Coordinates: <span className="text-on-surface">37.7749° N, 122.4194° W</span></div>
                  <div>FW Version: <span className="text-on-surface">AetherOS v4.1.14</span></div>
                  <div>Supervisor: <span className="text-on-surface">shadmansajid876@gmail.com</span></div>
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-2 border-t border-outline-variant/50">
                ...
                >
                  <PhoneCall className="w-4 h-4 text-primary" /> Contact SysOp
                </a>
                <a
                  href="https://aetheros.iot/docs"
                  target="_blank"
                  rel="noreferrer"
